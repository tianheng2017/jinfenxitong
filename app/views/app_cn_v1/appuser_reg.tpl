            ...
            <div class="page-content">
                ...
                <div class="block" style="margin: 10px 0 15px 0;">
                    ...
                    <div class="margin-top">
						<span style="font-size: 26px;font-weight: bold;color: #BC9568;">注册</span>
					</div>
                </div>
                <div class="login-box block">
						...
						<form action="#" id="form_post" name="form_post" method="post">
							<ul>
								<li class="item-content item-input">
									<div class="item-inner">
										<div class="item-input-wrap">
											...
											<input style="display:inline-block;float:left;width:55%;" id="username" type="text" name="username" placeholder="手机号">
										</div>
									</div>
								</li>
								<!--li class="item-content">
									<div class="item-inner">
										<div class="item-input-wrap">
											...
											<input id="codeusername" type="text" name="codeusername" placeholder="验证码">
										</div>
								...
								<li class="item-content item-input">
									<div class="item-inner">
										<div class="item-input-wrap">
											<input id="passwordtwo" type="password" name="passwordtwo" placeholder="安全密码">
										</div>
									</div>
								</li>
								<li class="item-content item-input">
									<div class="item-inner">
										<div class="item-input-wrap">
											<input id="superioruid" type="text" name="superioruid" placeholder="邀请码" value="<{$superioruid}>" <{$readonly}>>
										</div>
									</div>
								</li>
							</ul>
					...
					<button id="submits" style="cursor:pointer;color:#757575;font-size: 16px;width:110px;height:45px;background:rgba(36,36,38,1);border-radius:48px;border: 1px solid #242426;position: absolute;top: 340px;right: 40px;" disabled="disabled">注册</button>
				</div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
	$('#username,#password,#passwordtwo,#superioruid').keyup(function(){
		if ($('#username').val() && $('#password').val() && $('#passwordtwo').val() && $('#superioruid').val()){
			$('#submits').attr('style','cursor:pointer;color:#fff;font-size: 16px;width:110px;height:45px;background:linear-gradient(128deg,rgba(223,199,161,1) 0%,rgba(188,149,104,1) 100%);box-shadow:0px 6px 21px 0px rgba(191,153,109,0.1);border-radius:48px;border:1px solid rgba(151,151,151,1);position: absolute;top: 340px;right: 40px;');
			$("#submits").prop("disabled",false);
		}else{
			$('#submits').attr('style','cursor:pointer;color:#757575;font-size: 16px;width:110px;height:45px;background:rgba(36,36,38,1);border-radius:48px;border: 1px solid #242426;position: absolute;top: 340px;right: 40px;');
...
<script>
	$(document).ready(function () {
		...
		$("#submits").click(function () {
			var options = {
				url: "<{WSURLSHOW($WsCtrlClass,'regform')}>",
				type: 'post',
				dataType: 'text',
