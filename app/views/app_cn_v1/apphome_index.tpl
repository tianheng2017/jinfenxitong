...
<head>
    ...
    <link rel="stylesheet" href="<{VIEW_ROOTPATH}>/assets/wap/css/swiper.min.css">
    <link rel="stylesheet" href="<{VIEW_ROOTPATH}>/assets/wap/css/layer.css">
</head>
<style>
    img {
        display: initial;
            ...
            <ul class="menu-footer clearfix">
                <li>
                    <a href="<{WSURLSHOW('apphome','index')}>" class="external">
                        <img src="<{VIEW_ROOTPATH}>/assets/wap/img/licai_on.png" alt="" width="22" height="22" style="margin-bottom: 5px;">
                        <span>理财</span>
                    </a>
                </li>
                <li>
            ...
            <div class="page-content" style="padding-bottom: 100px;background: #2C2C2E;">
                <!--div class="swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide"><img src="<{$slide['img']}>" alt="" height="200"></div>
                        <{/foreach}>
                    </div>
                ...
                <div style="padding: 0 10px;margin: 20px 0 10px;text-align: center;">
                ...
                <div style="position: relative;cursor: pointer;padding: 0 10px!important;">
                    <{foreach from=$tradeorders item=$order}>
                    <div id="<{$order['id']}>" onclick="join(this);" style="padding:10px 17px;background:rgba(36,36,38,1);border-radius:12px;margin-bottom: 8px;">
                        <div style="border-bottom: 1px solid #2d2d2d;">
                            ...
                            <span style="float: right;height:37px;font-family:PingFangSC-Medium,PingFang SC;font-weight:500;color:rgba(173,173,173,1);line-height:50px;">
                                <img src="<{VIEW_ROOTPATH}>/assets/wap/img/more.png" alt="" width="20" height="20">
                            </span>
                        </div>
...
<script src="<{VIEW_ROOTPATH}>/assets/wap/js/swiper.min.js"></script>
...
<script type="text/javascript" src="<{VIEW_ROOTPATH}>/assets/wap/js/layer.js"></script>
<script>
    ...
    layer.open({
        type: 1
        ,content: '<img src="<{VIEW_ROOTPATH}>/assets/wap/img/hongbao.png" width="200" onclick="hongbao();">'
    });
    function hongbao() {
        $.get('/apphome/tystartdo/id/' + <{$ty.id}>, function (res) {
            res = JSON.parse(res);
            if(res.code){
