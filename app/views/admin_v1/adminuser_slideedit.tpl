...
<body>
                                    ...
                                    <div class="row">
                                        <form class="col s12" id="dataform">
                                            <div class="row">
												...
												<div class="input-field col s6" style="display:;">
                                                    <input id="passwordtwo" value="<{$data.status}>" name="status" type="text">
    ...
    <script type="text/javascript">
        $(".btnvideoadd").click(function () {
            ...
            var options = {
                url: "<{WSURLSHOW($WsCtrlClass,'slideedit_do')}>",
                type: 'post',
                dataType: 'text',
				...
				//alert(data);
					...
					if (data.length > 0) {
						if (data == "成功") {
							Materialize.toast('<span style="color: #0fef72">编辑成功!</span>', 3000);
						}
						if (data !="成功") {
