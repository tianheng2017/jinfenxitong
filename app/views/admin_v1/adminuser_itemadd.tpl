                                        ...
                                        <form class="col s12" id="dataform">
                                            <div class="row">
                                                ...
                                                <div class="input-field col s6" style="display:;">
                                                    <input id="password" name="type" type="number">
                                                    <label for="password">项目类型 0定期项目 1活期项目</label>
                                                </div>
                                                <div class="input-field col s6">
                                                    <input id="price" name="price" type="text">
                                                    <label for="price">项目金额(元)</label>
                                                </div>
												<div class="input-field col s6" style="display:;">
                                                    <input id="passwordtwo" name="arate" type="text">
                                                    <label for="passwordtwo">年化利率（%）</label>
                                                </div>
												<div class="input-field col s6" style="display:;">
                                                    <input id="passwordtwo" name="day_num" type="number">
                                                ...
                                                <!--div class="input-field col s6" style="display:;">
                                                    <input id="password" name="isty" type="number">
                                                    <label for="password">类型：0.普通项目 1.新手体验金项目</label>
                                                </div>
                                                <div class="input-field col s6" style="display:;">
                                                    <input id="password" name="tymoney" type="text">
