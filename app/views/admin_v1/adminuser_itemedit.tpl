...
<body>
                                        ...
                                        <form class="col s12" id="dataform">
                                            <div class="row">
                                                ...
                                                <div class="input-field col s6" style="display:;">
                                                    <input id="type" value="<{$data.type}>" name="type" type="number">
                                                    <label for="type">项目类型 0定期项目 1活期项目</label>
                                                </div>
                                                <div class="input-field col s6">
                                                    <input id="price" name="price" value="<{$data.price}>" type="text">
                                                    <label for="price">项目金额(元/份)</label>
                                                </div>
												<div class="input-field col s6" style="display:;">
												...
												<div class="input-field col s6" style="display:;">
                                                    <input id="passwordtwo" value="<{$data.day_num}>" name="day_num" type="number">
                                                    <label for="passwordtwo">项目天数(天)</label>
                                                </div>
                                                <div class="input-field col s6" style="display:;">
                                                    <input id="desc" value="<{$data.desc}>" name="desc" type="text">
                                                    <label for="desc">项目特色</label>
                                                </div>
                                                <!--div class="input-field col s6" style="display:;">
                                                ...
                                                <div class="input-field col s6" style="display:;">
                                                    <input id="password" value="<{$data.tymoney}>" name="tymoney" type="text">
                                                ...
                                                <div class="input-field col s6" style="display:;">
                                                    ...
                                                    <!--label for="password">赠送优惠券金额（0为不赠送,否则优惠劵不得低于项目金额的15%）</label-->
                                                </div-->
    ...
    <script type="text/javascript">
        $(".btnvideoadd").click(function () {
            ...
            var options = {
                url: "<{WSURLSHOW($WsCtrlClass,'itemedit_do')}>",
                type: 'post',
                dataType: 'text',
